...
var lyrics = ["Can we lose our minds and call it love?", "Give me your heart and your hand and we can run", "I didn't mean to burden you with love in my condition",
    ...
    "I promise you one day we'll tell ourselves 'oh my god this is paradise'"
]
...
function submit() {
    var video = document.createElement("iframe") /* Create iframe element */
    var url = document.getElementById("video-url").value /* Get URL that the user input */
    var container = document.getElementById("center") /* Get the container that the iframe will go in */
    video.id = "video" /* Assign the id of the iframe */
    video.allowFullscreen = true /* Self-explanitory */
    video.setAttribute("src", url) /* Set the url */
    container.appendChild(video) /* Add to page */
}
